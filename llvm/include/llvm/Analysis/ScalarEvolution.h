...
public:
  ...
  public:
    ...
    bool operator==(const FoldID &RHS) const {
      void *RawPtr = Op.getRawPointer();
      void *RawPtrRHS = RHS.Op.getRawPointer();
      return std::tie(RawPtr, Ty, C) == std::tie(RawPtrRHS, RHS.Ty, RHS.C);
    }
  };
